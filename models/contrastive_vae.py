...
class CVAE(nn.Module):
    ...
    def forward(self, x, x_aug=None):
        ...
        if x_aug is not None:
            ...
            return x_recon, x, mu, logvar, z, z_aug
        else:
            return x_recon, x, mu, logvar, z, None
    ...
    def loss_function(self, args, contrastive=False, contrastive_weight=1.0):
        x_recon, x, mu, logvar, z, z_aug = args
        ...
        if contrastive and z_aug is not None:
            contrastive_loss = self.contrastive_loss(z, z_aug)
